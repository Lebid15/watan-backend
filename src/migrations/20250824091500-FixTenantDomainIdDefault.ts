...
export class FixTenantDomainIdDefault20250824091500 implements MigrationInterface {
  name = 'FixTenantDomainIdDefault20250824091500';
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
DO $$
DECLARE v text; BEGIN
  BEGIN CREATE EXTENSION IF NOT EXISTS "pgcrypto"; EXCEPTION WHEN others THEN END;
  SELECT column_default INTO v FROM information_schema.columns WHERE table_name='tenant_domain' AND column_name='id';
